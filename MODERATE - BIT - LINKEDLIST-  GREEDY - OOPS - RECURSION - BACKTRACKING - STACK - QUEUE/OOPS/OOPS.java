public class OOPS {
      ...
      public static void StudentsCall() {
            ...
            // if we change s1 marks after copy constructor ...then s4 marks will also
            // change,...
            s1.marks[0] = 100;
      ...
      public static void AbstractsAnimalsCall() {
            ...
            // Animals a =new Animals(); // this line will give you an error (walk is not
            // define)
            Horse Joe = new Horse();
            Joe.eat();
            Joe.walk();
            System.out.println(Joe.color);
            // we have to first call the function to change the color from parent class to
            // existing class
            Joe.changeColor();
            System.out.println(Joe.color);
...
// here both fish and dogs are using animals class hence it's called hierarchial
// inheritance...
